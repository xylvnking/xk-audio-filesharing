...
/*
    this hook gets all the data we have about the song once the users access is validated
*/

// called from SessionHomeComponent.js
        ...
        if (auth, songDocumentId) { // require official auth here makes it so that they can only access songs they're authorized on anyways according to security rules
            const getSongDataFromFirebase = async () => {
                ...
                if (songDocumentSnapshot.exists()) {
                    ...
                    // this is what i used before implementing security rules, which rendered this redundant
                        // i'm keeping it here just incase i have to redo security rules and need this
                    ...
                    if (userHasAccess == true) {
                        ...
                        /*
                            ...
                            // without fixing that, removing the relevant parts of this block won't block the ghost users from the ui
